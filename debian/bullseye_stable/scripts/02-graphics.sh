...
# xorg 				- (x11): X.Org X Window System
# xserver-xorg		- (x11): X.Org X server
# xinit				- X server initialisation tool [Special useful WITHOUT Display Manager]
# xutils 			- (x11): X Window System utility programs
MY_DISPLAY_SERVER="xorg xserver-xorg xinit xutils"
