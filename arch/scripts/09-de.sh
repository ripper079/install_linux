...
# Maybe GNUpg????
MY_DESKTOP_EVVIRONMENT="firefox thunderbird pcmanfm ranger vlc libreoffice-still libreoffice-still-sv geeqie sxiv keepassxc rofi xarchiver copyq qpdfview xchm gparted"
